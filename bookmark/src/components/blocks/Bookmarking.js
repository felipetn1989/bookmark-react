  ...
  return (
    <div className="relative flex flex-col gap-20 my-[3.5625rem] lg:my-11 lg:gap-32 lg:flex-row lg:px-[8.5rem]">
      ...
      <div className="flex flex-col gap-3.5 lg:text-left lg:gap-7">
        ...
        <button className={`bg-[#5368df] text-white text-sm font-medium shadow-md px-[1.1875rem] py-3.5 tracking-wide rounded-md m-auto hover:bg-white hover:text-[#5368df] lg:m-[unset] lg:px-6 lg:self-start lg:mt-1`}>
            More Info
        </button>
      </div>
    </div>
